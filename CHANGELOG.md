...
### Fixed
- Made memory indexing and rebuild resilient to scalar, numeric, date, and otherwise malformed external YAML metadata.
- Preserved scalar tags and aliases when repairing frontmatter instead of discarding them.
- Removed the unintended 500-note cap from full memory index generation.
...
[0.1.3]: https://github.com/deepak-bhardwaj-ps/smriti-mcp/releases/tag/v0.1.3
